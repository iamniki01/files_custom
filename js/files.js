(function (window, $, RightClick, undefined) {
    ...
    new RightClick.Menu($('tbody[class=files-fileList]'), function (event, context, delimiter) {
        ...
        if (currentFile.hasClass('selected')) {
            ...
            // addNewOption('Check', 'category-dsiabled', t)
            ...
            // Add a new custom command option to the context menu
            addNewOption('CustomCommand', 'icon-bash', 'Custom Command', function () {
                // Define the behavior of the custom command here
                alert('Custom command was clicked!');
            });
        }
        else {
